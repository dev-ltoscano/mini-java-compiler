...
public:
  ...
  enum {
    ...
    RuleMethodBody = 4, RuleMethodReturn = 5, RuleMethodCall = 6, RuleParams = 7, 
    RuleType = 8, RuleVarDecl = 9, RuleVarDeclAndAtt = 10, RuleStatement = 11, 
    RuleExpression = 12, RuleExpList = 13
  };
